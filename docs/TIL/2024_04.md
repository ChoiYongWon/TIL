...
캐시의 max-age가 항상 0인 값 사용하려고 할 때마다 재검증 요청을 보냄

**no-store**

캐시를 아예 저장안함. 가장 강력한 Cache-Control 값

**public**

중간 서버(cdn)도 캐시를 저장할 수 있음

**private** 

가장 끝에 사용자만 캐시를 저장할 수 있음

**s-maxage**

중간 서버에만 적용되는 캐시 max-age
...
![](https://github.com/ChoiYongWon/AT/assets/40623433/4bc82bb6-457a-46ca-a760-ccdd5ce2d8fa)
